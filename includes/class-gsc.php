...
class Gsc {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Gsc_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'GSC_VERSION' ) ) {
			$this->version = GSC_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'gsc';
	 ...
	 * - Gsc_Admin. Defines all hooks for the admin area.
